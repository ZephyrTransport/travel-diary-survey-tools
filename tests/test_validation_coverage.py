...
def test_person_fixture_has_all_required_fields():
    ...
    try:
        validate_row_for_step(person_dict, PersonModel, "persons", step_name="extract_tours")
...
def test_household_fixture_has_all_required_fields():
    ...
    try:
        validate_row_for_step(hh_dict, HouseholdModel, "households", step_name="extract_tours")
    except (ValueError, KeyError, TypeError) as e:
...
def test_trip_fixture_has_all_required_fields():
    ...
    try:
        validate_row_for_step(trip_dict, LinkedTripModel, "linked_trips", step_name="extract_tours")
    except (ValueError, KeyError, TypeError) as e:
